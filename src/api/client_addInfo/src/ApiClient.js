...
export default class ApiClient {
    constructor() {
         ...
         */
        this.basePath = 'http://localhost:8083/v1/'.replace(/\/+$/, '');
    ...
    * @param {{user_id: Number, content_id: Number, profile_id: Number}} pathParams A map of path parameters and their values.
            ...
            default:
                if (type === Object) {
                    ...
                    if (Array.isArray(data)) {
                        ...
                        // If data is not an array, handle appropriately (e.g., wrap in an array or return as-is)
                        console.warn('Expected array but received:', data);
                        return [ApiClient.convertToType(data, itemType)];
                    }
