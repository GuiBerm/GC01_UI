...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateReviewRequest', function() {
      beforeEach(function() {
        instance = new AdditionalInfoManagementApi.UpdateReviewRequest();
      });

      it('should create an instance of UpdateReviewRequest', function() {
        // TODO: update the code to test UpdateReviewRequest
        expect(instance).to.be.a(AdditionalInfoManagementApi.UpdateReviewRequest);
      });
