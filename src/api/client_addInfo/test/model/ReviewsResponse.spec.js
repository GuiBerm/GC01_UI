...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReviewsResponse', function() {
      beforeEach(function() {
        instance = new AdditionalInfoManagementApi.ReviewsResponse();
      });

      it('should create an instance of ReviewsResponse', function() {
        // TODO: update the code to test ReviewsResponse
        expect(instance).to.be.a(AdditionalInfoManagementApi.ReviewsResponse);
      });
