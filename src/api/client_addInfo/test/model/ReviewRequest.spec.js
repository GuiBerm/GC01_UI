...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReviewRequest', function() {
      beforeEach(function() {
        instance = new AdditionalInfoManagementApi.ReviewRequest();
      });

      it('should create an instance of ReviewRequest', function() {
        // TODO: update the code to test ReviewRequest
        expect(instance).to.be.a(AdditionalInfoManagementApi.ReviewRequest);
      });
