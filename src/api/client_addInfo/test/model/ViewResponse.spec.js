...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ViewResponse', function() {
      beforeEach(function() {
        instance = new AdditionalInfoManagementApi.ViewResponse();
      });

      it('should create an instance of ViewResponse', function() {
        // TODO: update the code to test ViewResponse
        expect(instance).to.be.a(AdditionalInfoManagementApi.ViewResponse);
      });

      it('should have the property views (base name: "views")', function() {
        // TODO: update the code to test the property views
